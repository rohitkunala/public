...
*/		
		...
		import java.awt.*;
		import java.net.*;
		public class LANServ extends JFrame implements ActionListener
		{
			...
			public LANServ()
			{
				...
				l1=new JLabel("<html><font color='blue' style='font-size:22px'>NetworKING(server)</font></html>");
				...
				l8=new JLabel("<html><font color='red' style='font-size:12px'>CHAT(Server)</html>");
			...
			public void actionPerformed(ActionEvent ae)
			{
				...
				else if(ae.getSource()==b31)//ping rest
				{
					tf1.setText("");
					l5.setText("");
					l5.setText("Check here after tapping ping");
				}
				else if(ae.getSource()==b5)//chat send
				{
					try{
					...
					for(int i=Integer.parseInt(a[1]);i<=Integer.parseInt(a[2]);i++)
				{
					...
					if(InetAddress.getByName(st).isReachable(1000))
					ta1.append(st+'\n');
				}
				ta1.append("sweep ended\n");
				}
				else if(ae.getSource()==b71)//sweep reset
				{
					tf3.setText("");
					ta1.setText("");
				}
				else if(ae.getSource()==b8)//port scan
				{
				...
				else if(ae.getSource()==b81)//port scan reset
				{
					tf4.setText("");
					ta2.setText("");
				}
	...
	public static void main(String args[])throws Exception
	{
        ...
        String msginput = "";
        try{
			try{skt = new ServerSocket(Integer.parseInt(args[0]));}
			catch(Exception e){}
